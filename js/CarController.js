...
CarController.prototype.update = function (dt) {
    ...
    if (countdown) { this._applyFriction(dt); return; }
    if (!racing)   { this._applyFriction(dt); return; }
    ...
    if (input.accel) {
        ...
        if (this._speed > 0) {
            ...
            this._speed -= (this.brakeForce * 0.4) * dt;
        }
    } else {
    ...
    this.entity.setEulerAngles(0, this._heading, this._steer * -8);
